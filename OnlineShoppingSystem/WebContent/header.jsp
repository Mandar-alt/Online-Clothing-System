...
<div class="collapse navbar-collapse menu--shylock"
	...
	<ul class="nav navbar-nav menu__list">
		...
		<li class="active menu__item menu__item"><a class="menu__link"
			href="mens.jsp">Mens Clothes </a></li>
		<li class=" menu__item"><a class="menu__link"
			href="womens.jsp">Womens Clothes</a></li>
		
		<%
			if ((String) session.getAttribute("name") != null) {
		%>
		<li class=" menu__item"><a href="feedback.jsp" class="menu__link">&nbsp;&nbsp;&nbsp;Give Feedback</a></li>
		...
		%>
		<li class=" menu__item"><a href="view-feedback.jsp" class="menu__link">&nbsp;&nbsp;&nbsp;View Feedback</a></li>
	    <li class=" menu__item"><a class="menu__link" href="contact.jsp">Contact Us&nbsp;</span></a></li>
		<li class="menu__item"><a class="menu__link"
