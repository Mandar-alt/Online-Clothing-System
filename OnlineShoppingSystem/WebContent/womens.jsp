...
<body>
	...
	<div class="men-wear">
		<div class="container">
			...
			<%
				ResultSet retriveProduct = DatabaseConnection.getResultFromSqlQuery("select * from tblproduct where product_category='Womens Wear Clothes'");
				while (retriveProduct.next()) {
			%>
			<a href="clothes-add-to-cart.jsp?id=<%=retriveProduct.getInt("id")%>">
