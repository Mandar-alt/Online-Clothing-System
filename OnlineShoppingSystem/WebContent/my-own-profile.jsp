 ...
 %>
	...
	<div class="checkout">
		<div class="container">
			<h3>My Profile</h3>
			<%
				String info = (String) session.getAttribute("update");
				if (info != null) {
					session.removeAttribute("update");
			%>
			<div class='alert alert-info' id='info' style="width: 680px;">Information updated sucessfully.</div>
			<%
				}
			%>
						...
						<div class="form-row">
							<div class="form-group col-md-6">
								<label>Customer Name</label> <input type="text" name="cname"
									class="form-control" value="<%=rs.getString("name")%>" readonly>
							</div>
							<div class="form-group col-md-6">
						...
						<div class="form-row">
							<div class="form-group col-md-12">
								...
								<textarea name="address" class="form-control" rows="5"
									style="height: 100%;"><%=rs.getString("address")%></textarea>
							</div>
						</div>
						<div class="form-row">
							<div class="form-group col-md-6">
								<label>Pincode</label> <input type="text" name="pincode"
									value="<%=rs.getString("pin_code")%>" class="form-control">
							</div>
							<div class="form-group col-md-6">
								<label>Mobile No</label> <input type="phone" name="phone"
									value="<%=rs.getString("phone")%>" class="form-control">
							</div>
						</div>
