 ...
 %>
	...
	<div class="contact">
		<div class="container">
			...
			<form action="Contact" method="post" id="form" role="form">
				<div class="contact-form2">
					<input type="text" name="name" id="name" value="Name"
						onfocus="this.value = '';"
						onblur="if (this.value == '') {this.value = 'Name';}"
						onkeypress="return lettersValidate(event)"> <input
					...
					<br> <input type="text" name="subject" id="subject"
						...
						style="width: 1135px;" onkeypress="return lettersValidate(event)">
					<textarea type="text" name="message" id="message"
						onfocus="this.value = '';"
						onblur="if (this.value == '') {this.value = 'Message...';}">Message...</textarea>
					<input type="submit" value="Submit" id="buttonValidate">
				</div>
			</form>
		</div>
	</div>
