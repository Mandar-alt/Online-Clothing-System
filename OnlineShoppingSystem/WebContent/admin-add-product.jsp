							...
							<form role="form" action="AddProducts" method="post"
								...
								<div class="form-group">
									<label>Enter Name</label> <input class="form-control"
										type="text" name="pname" placeholder="Product Name" onkeypress="return lettersValidate(event)"/>
								</div>
								<div class="form-group">
									<label>Discount Price</label> <input class="form-control" type="text"
										name="price" placeholder="Product Discount Price" onkeypress="return numberValidate(event)"/>
								</div>
								<div class="form-group">
									<label>Description</label> <input class="form-control"
										type="text" style="min-height: 100px;" name="description" placeholder="Product Description"/>
								</div>
								<div class="form-group">
									<label>MRP Price</label> <input class="form-control"
										type="text" name="mprice" placeholder="MRP Price" onkeypress="return numberValidate(event)"/>
								</div>
								<div class="form-group">
