							...
							<form action="AddCustomer" method="post">
								<div class="sign-up">
									...
									<input type="text" placeholder="Your Name" required=""
										style="width: 680px;" name="name" onkeypress="return lettersValidate(event)">
								</div>
								<div class="sign-up">
									<h4>Email :</h4>
									<input type="text" placeholder="Type here" required=""
										style="width: 680px;" name="email" id="email">
								</div>
								<div class="sign-up">
									<h4>Password :</h4>
									<input type="password" placeholder="Password" required=""
										style="width: 680px;" name="password" required oninput="limitChar(this)"
												maxlength="12">
								...
								<div class="sign-up">
									<h4>Phone :</h4>
									<input type="text" placeholder="Type here" required=""
										style="width: 680px;" name="mobile" onkeypress="return numberValidate(event)" maxlength="10">
								</div>
								<div class="sign-up">
									<h4>Gender :</h4>
								...
								<div class="sign-up">
									...
									<input type="text" placeholder="Pincode" required=""
										style="width: 680px;" name="pincode" onkeypress="return numberValidate(event)" maxlength="6">

								</div>
								<div class="sign-up">
									<input type="submit" value="REGISTER NOW" id="buttonValidate" style="width: 680px;">
								</div>
